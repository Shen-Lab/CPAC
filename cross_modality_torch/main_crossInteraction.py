...
if args.train == 1:
    ...
    for epoch in range(args.epoch):
        ...
        if loss_epoch_val/batch_val < loss_val_best:
            ...
            torch.save(model.state_dict(), './weights/crossInteraction_' + str(args.l0) + '_' + str(args.l1) + '_' + str(args.l2) + '_' + str(args.l3) + '.pth')
...
###### evaluation ######
# evaluation
model.load_state_dict(torch.load('./weights/crossInteraction_' + str(args.l0) + '_' + str(args.l1) + '_' + str(args.l2) + '_' + str(args.l3) + '.pth'))
model.eval()
