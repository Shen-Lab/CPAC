...
if args.train == 1:
    ...
    for epoch in tqdm(range(args.epoch)):
        ...
        if loss_epoch_val/batch_val < loss_val_best:
            ...
            torch.save(model.module.state_dict(), './weights/concatenation_transformer_' + str(args.l0) + '_' + str(args.l1) + '_' + str(args.l2) + '_' + str(args.l3) + '.pth')
...
model.load_state_dict(torch.load('./weights/concatenation_transformer_' + str(args.l0) + '_' + str(args.l1) + '_' + str(args.l2) + '_' + str(args.l3) + '.pth'))
model.eval()
