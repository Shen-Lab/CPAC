...
reg_inter = interaction_penalty_bce(batch=batch_size,mylambda=lambda_interaction)([prot_inter,prot_inter_exist,joint_attn_1])
...
filepath = './weights/deepmodality_seq_bce.h5'
