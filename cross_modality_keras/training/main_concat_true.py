...
l1_binding = 0.0001 # float(sys.argv[3]) #0.01
# lambda_interaction = 1000 # float(sys.argv[4]) # 1000
lambda_interaction = 10000 # float(sys.argv[4]) # 1000
seed = 0 # int(sys.argv[5]) # 1000
ww = 0.5 # 1000
num_gnn_layer = 7
# filepath="./weights_hrnn_gcn0_" + str(seed) + "/weights_gcn_newattn_" + str(l1_fused_binding) + '_' + str(l2_group_binding) + '_' + str(l1_binding) + '_' + str(lambda_interaction) + '_' +  str(num_gnn_layer) + "_{epoch:02d}"
# filepath="./weights_hrnn_gcn0_" + str(seed) + "/weights_gcn_newattn_" + str(l1_fused_binding) + '_' + str(l2_group_binding) + '_' + str(l1_binding) + '_' + str(lambda_interaction) + '_' +  str(num_gnn_layer) + '_137'


filepath = './weights/deepmodality_concat_true.h5'
