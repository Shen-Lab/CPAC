...
lambda_interaction = 100000 # float(sys.argv[4]) # 1000
seed = 0 # int(sys.argv[5]) # 1000
num_gnn_layer = 7
# filepath="./weights_gcn1_" + str(seed) + "/weights_gcn_" + str(l1_fused_binding) + '_' + str(l2_group_binding) + '_' + str(l1_binding) + '_' + str(lambda_interaction) + '_' +  str(num_gnn_layer) + "_{epoch:02d}"
# filepath="./weights_gcn1_" + str(seed) + "/weights_gcn_" + str(l1_fused_binding) + '_' + str(l2_group_binding) + '_' + str(l1_binding) + '_' + str(lambda_interaction) + '_' +  str(num_gnn_layer) + "_460"
# filepath= "weights_gcn_" + str(l1_fused_binding) + '_' + str(l2_group_binding) + '_' + str(l1_binding) + '_' + str(lambda_interaction) + '_' +  str(num_gnn_layer) + '_350'
filepath = './weights/deepmodality_graph_true.h5'
...
prot_train_contacts = np.load(data_processed_dir+'prot_train_contacts_true.npy')
...
prot_dev_contacts = np.load(data_processed_dir+'prot_dev_contacts_true.npy')
...
prot_test_contacts = np.load(data_processed_dir+'prot_test_contacts_true.npy')
